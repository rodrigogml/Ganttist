...
| 2026-09-22 | SURF-WEB-OPERATIONS | Busca unificada e views privadas cobrem Tarefas e Gantt na mesma barra de comandos | Uma expressão única e snapshots por usuário/projeto preservam paridade funcional entre os modos sem compartilhamento implícito | `unified-task-views` briefing, spec e plano |
| 2026-09-24 | SURF-WEB-OPERATIONS | Recorrência, ocorrência corrente, soneca e histórico cobrem Gantt e Tarefas | A mesma projeção autorizada preserva paridade operacional em layout responsivo, sem compartilhar cálculo de calendário ou série com o navegador | `recurring-tasks-snooze` briefing, spec e plano |
