...
final class WorkspaceController extends Controller
{
    ...
    private function tasks(): array
    {
        $tasks = [
            ...
            ['id' => 't3', 'title' => 'Design system e fundações', 'kind' => 'task', 'level' => 1, 'start' => '2026-08-24', 'finish' => '2026-08-27', 'progress' => 70, 'status' => 'scheduled', 'critical' => true, 'priority' => 4, 'assignee' => 'AS'],
