...
describe('autonomous workspace', () => {
  ...
  it('accepts the in-progress calculated status', () => {
    const workspace = parseWorkspaceResponse({ data: { project: { id: 'local', name: 'Local', source: 'Local', sync_status: 'local', updated_at: '2026-08-25T00:00:00Z' }, tasks: [{ id: 'task', title: 'Entrega', kind: 'task', level: 0, start: '2026-08-25', finish: '2026-08-29', plannedDurationWorkdays: 5, resolved_duration_workdays: 5, schedule_constraint_state: 'satisfied', schedule_constraint_reason: null, progress: 0, status: 'in_progress', critical: false }], dependencies: [], stats: { progress: 0, completed: 0, total: 1, critical: 0 } } })
