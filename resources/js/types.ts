...
export interface Task { id:string; title:string; kind:'task'|'group'; level:number; start:string|null; finish:string|null; progress:number; status:TaskStatus; critical:boolean; priority?:number; assignee?:string }
